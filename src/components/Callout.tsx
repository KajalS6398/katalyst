...
const calloutVariants = cva("py-3 px-4 font-medium rounded-md", {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      intent: "primary",
      className:
        "border-primary-200 text-primary-600 bg-transparent dark:text-primary-400",
    },
    {
      variant: "filled",
      intent: "warning",
    ...
    },
    {
      ...
      intent: "success",
      className:
        "bg-green-50 dark:bg-green-900 dark:text-green-400 text-green-600",
    },
    {
      variant: "outlined",
      intent: "success",
    ...
    },
    {
      ...
      intent: "default",
      className:
        "border-gray-300 text-gray-700 bg-transparent dark:text-gray-400",
    },
  ],
  defaultVariants: {
    variant: "filled",
